...
<p align="center">
  ...
  <p align="center">
    ...
    <br />
    <a href="https://github.com/sanmak/awesome-blogs"><strong>Explore the docs »</strong></a>
    <br />
    <br />
    ·
    <a href="https://github.com/sanmak/awesome-blogs/issues">Report Bug</a>
    ·
    <a href="https://github.com/sanmak/awesome-blogs/issues">Request Feature</a>
  </p>
</p>

# Human Name Starts With
...
* Alex Danco https://zerotousers.substack.com/
...
* Ankur Warikoo https://ankurwarikoo.com/blog/
...
* Digital Deepak https://digitaldeepak.com/
...
* Jackson Kelley https://console.substack.com/
...
* Monica Lent https://bloggingfordevs.com/
* Monica Lent https://notanomadblog.com/
...
* Paras Chopra https://invertedpassion.com/
...
See the [open issues](https://github.com/sanmak/awesome-blogs/issues) for a list of proposed features (and known issues). Not all blogs may run when you use, so consider updating those. An Open Source Contribution.
...
1. Fork the Project
2. Create your Feature Branch (`git checkout -b add/blog`)
3. Commit your Changes (`git commit -m 'Add some AmazingFeature'`)
4. Push to the Branch (`git push origin add/blog`)
